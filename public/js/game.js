...
function showQuestion() {
  // Si ya se completaron todas las preguntas, no mostrar más modales
  ...
  showNextQuestion(() => {
    // Continuar el juego después de responder
    isGamePaused = false;
    isShowingQuestion = false;
    // Resetear las velocidades de colisión
...
function loop() {
  ...
  // Si el juego está pausado, no actualizar nada excepto el renderizado
  if (isGamePaused) {
  ...
  // Solo ejecutar animaciones si el juego no está pausado
  if (!isGamePaused) {
